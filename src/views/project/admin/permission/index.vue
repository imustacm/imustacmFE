<template>
  <div class="table-container" style="margin: 20px">
    ...
    >
      ...
      >
        <template #default="{ row }">
          <el-button type="text" @click="handleInter(row)">配置</el-button>
        </template>
      </el-table-column>
      <el-table-column
        show-overflow-tooltip
...
<script>
  import { getList, doDelete } from '@/api/permission'
  import TableEdit from './components/TableEdit'
  import InterTable from './components/InterTable'

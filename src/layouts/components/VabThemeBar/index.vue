...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('imustacm-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName(
          'body'
        )[0].className = `imustacm-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`imustacm-theme-${name}`)
        localStorage.removeItem('imustacm-theme')
